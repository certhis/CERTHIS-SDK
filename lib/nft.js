...
module.exports = function (request) {
  ...
  var get_proof = async function (collection_object = null, nft_id, current_address,web3) {
  ...
  var mint = async function (
    ...
    return new Promise(async (resolve, reject) => {
      ...
      var mint_proof = await get_proof(collection, nft.nft_id, current_address, web3);
