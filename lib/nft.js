...
module.exports = function (request) {
  ...
  var format = function (obj) {
    return {
      nft_id:  empty(obj.nft_id)
      ? 0
      : BigInt(obj.nft_id),
      collection_id:  empty(obj.collection_id)
      ? 0
      : BigInt(obj.collection_id),
      owner_address: obj.owner_address,
      creator_address: obj.creator_address,
      token_uri: obj.token_uri,
      sellable_type: empty(obj.sellable_type)
      ? 0
      : BigInt(obj.sellable_type),
      sellable_currency: empty(obj.sellable_currency)
        ? "0x0000000000000000000000000000000000000000"
        : obj.sellable_currency,
      sellable_amount: empty(obj.sellable_amount)
        ? 0
        : BigInt(obj.sellable_amount),
      royalties:
        empty(obj.royalties) || isNaN(obj.royalties) ? 0 : obj.royalties,
      affiliation: empty(obj.affiliation)
        ? "0x0000000000000000000000000000000000000000"
        : obj.affiliation,
      minted: true,
    };
