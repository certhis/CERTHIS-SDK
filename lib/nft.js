...
module.exports = function (request) {
  ...
  var get_proof = async function (
    ...
    return new Promise(async (resolve, reject) => {
      ...
      if (
        ...
        console.log('proof_mint',mint_proof.proof_mint);
        console.log('log76890',tree.getHexProof(leaf));
        if (tree.verify(tree.getProof(leaf), leaf, root) != true) {
          return resolve(false);
        } else {
          resolve(mint_proof);
  ...
  var mint = async function (
    ...
    return new Promise(async (resolve, reject) => {
      ...
      console.log('iciiii',current_address);
      var mint_proof = await get_proof(
        collection,
        nft.nft_id,
        current_address,
        web3
      ...
      console.log("minting", to_wallet, nft, mint_proof);
