module.exports = function (request, Web3, params)  {
  ...
  var format_collection = function (obj, contract_id = null, v2 = null) {
    ...
    if (v2 != null) {
      return_obj.sbt_contract = obj.sbt_contract;
      return_obj.burnable = obj.burnable;
    }
        ...
        if (humaingf > balance && force_balance == null) {
          ...
          try {
            await manage_collection
              ...
              .on("confirmation",   async ({ confirmations, receipt, latestBlockHash }) => {
                ...
                if (confirmations >= params.confirm_need && !confirmationFlag) {
                  ...
                  var collection_id = decodeLogsUntilEventName(
                    receipt.logs,
                    JSON.parse(load_contract.certhis_abi),
