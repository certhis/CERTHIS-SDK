module.exports = function (request, Web3, params) {
  ...
  const { multiplyBigIntByFloat, decodeLogsUntilEventName } =
    require("./extra")(Web3);
  var format_collection = function (obj, contract_id = null, v2 = null,v3 = null) {
    var return_obj = {
    ...
    if (v2 != null || v3 != null) {
      ...
      if(v3 != null){
        ...
        return_obj.custom_allowance = obj.custom_allowance == undefined ? false : obj.custom_allowance;
      }
    }
