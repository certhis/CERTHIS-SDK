module.exports = function (request) {
  return {
    async user(user_address,offset_id, mainnet) {
      return await request
        .get("transaction/user", { user: user_address,offset_id:offset_id, mainnet: mainnet });
    },
     ...
     async collection(collection_index,offset_id,update = null) {
      return await request
        .get("transaction/collection", { collection_index: collection_index,offset_id:offset_id, update: update });
    },
